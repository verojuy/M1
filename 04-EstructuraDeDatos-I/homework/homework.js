...
natural, su factorial (representado como n!) es el producto de n por todos 
...
tomando al 0 y al 1, respectivamente, como primer y segundo elementos de la misma,
 y sabiendo que cualquier elemento que se agregue a esta secuencia será el 
...
este problema pueden intentar definir funciones que logren los mismos resultados 
 de manera iterativa.
*/
...
function Queue() {
  ...
  Queue.prototype.enqueue = function(elemen){
      return this.array.push(elemen);
   }  
   Queue.prototype.dequeue = function (elemen){
     return  this.array.shift(elemen);
   }
   Queue.prototype.size = function (elemen){
